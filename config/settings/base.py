...
#settings in .vscode\launch.json
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': 'logs/detail_read.log',
            'formatter': 'make_simple',
        },
    },
    'loggers': {
        'article_read': {
...
AWS_S3_ACCESS_KEY_ID = env('ACCESS_KEY_ID')
AWS_S3_SECRET_ACCESS_KEY = env('SECRET_ACCESS_KEY')
AWS_S3_CUSTOM_DOMAIN = AWS_S3_ENDPOINT_URL + '/' + AWS_STORAGE_BUCKET_NAME
